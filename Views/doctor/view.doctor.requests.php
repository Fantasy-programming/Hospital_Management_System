...
<main class="height-100 bg-lig">
    <h1>Create/Accept appointments (will be populated in the calendar (green), operations are (red), communal(staff) events are yellow)</h1>
    <h1>Request lab services (must return result)</h1>
