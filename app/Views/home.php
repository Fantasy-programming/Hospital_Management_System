      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <ul class="navbar-nav w-100 d-flex flex-md-row flex-column  justify-content-between">
            <div></div>
            <div class="d-flex flex-md-row flex-column align-items-center  ms-5">
              <li class="nav-item"><a href="#hero" class="nav-link me-5 btn hero color-second text-white px-3 rounded-pill nvlink">Home</a></li>
              <li class="nav-item"><a href="#gallery" class="nav-link me-5 aboutus text-white nvlink">Gallery</a></li>
              <li class="nav-item"><a href="#services" class="nav-link me-5 services text-white nvlink">Services</a></li>
              <li class="nav-item"><a href="#contactUs" class="nav-link me-5 contact text-white nvlink">Contact Us</a></li>
              <li class="nav-item"><a href="#faq" class="nav-link me-5 faq text-white nvlink">FAQ</a></li>
            </div>
      ...
      <div class="footer-bottom mt-5">
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="d-flex gap-5 row-gap-2 w-75 flex-wrap mb-3"><a href="" class="text-white-50">Home</a><a href="" class="text-white-50">Services</a><a href="" class="text-white-50">Contact</a><a href="" class="text-white-50">Gallery</a><a href="" class="text-white-50">About Us</a></div>
